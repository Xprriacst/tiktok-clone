    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      <div className="max-w-md w-full text-center">
        ...
        <div className="space-y-4">
          ...
          <button
            onClick={() => navigate(-1)}
            className="w-full bg-surface border border-border text-text-primary px-6 py-3 rounded-lg font-medium hover:bg-background transition-colors duration-200 flex items-center justify-center space-x-2"
          >
